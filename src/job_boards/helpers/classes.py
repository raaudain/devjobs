...
class ProcessCompanyJobData:
    ...
    def filter_jobs(self, posting: dict):
        ...
        wanted = ["Engineer", "Data", "IT ",  "Tech ", "QA", "Programmer", "Developer", "ML", "SDET", "DevOps", "AWS", "Cloud", "Software", "Help", "Web ", "Front End", "Agile", "Cyber", "OSINT", "Intelligence", "Terraform", "Email"]
