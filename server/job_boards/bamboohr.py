...
def get_results(item: str, param: str):
    ...
    company = soup.find("img")["alt"] if soup.find("img")["alt"] else soup.find("meta", {"property": "og:description"})["content"].replace("Take a look at the current openings at", "").strip()
